...
// &&, ||, and, or, etc.) called the "Exclusive Or" (hence the name of this
// Kata). The exclusive or evaluates two booleans. It then returns true if
...
// the two expressions to be evaluated. Your xor function should have the
